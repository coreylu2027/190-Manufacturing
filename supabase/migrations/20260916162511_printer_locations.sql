alter table public.quality_control drop constraint quality_control_storage_location_check;
alter table public.quality_control add constraint quality_control_storage_location_check
