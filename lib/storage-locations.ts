...
export const STORAGE_LOCATION_GROUPS = [
  { name: "Clarke", locations: STORAGE_LOCATIONS.slice(0, 8) },
  { name: "Kwolek", locations: STORAGE_LOCATIONS.slice(8, 24) },
  { name: "Hopper", locations: STORAGE_LOCATIONS.slice(24, 32) },
  { name: "Jemison", locations: STORAGE_LOCATIONS.slice(32, 48) },
  { name: "Shelf", locations: STORAGE_LOCATIONS.slice(48, 51) },
] as const;
